  ...
  /*  }*/
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0:
                    TabFragment1 obj=new TabFragment1();
                    return obj;
                case 1:
                    TabFragment2 obj2=new TabFragment2();
                    return obj2;
                case 2:TabFragment3 obj3=new TabFragment3();
                    return obj3;
                default:
                    return null;
            }
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                   ...
                   /*Fragment obj=TabFragment1.newInstance();
                    replaceFragment(obj);*/
                    return "CONTACT";
                case 1:
                ...
                case 2:
                   /* Fragment obj2=TabFragment3.newInstance();
                    replaceFragment2(obj2);*/
                    return "MESSAGE";
    ...
    /*private void replaceFragment2(Fragment obj2) {
        FragmentManager fm = getSupportFragmentManager();
        FragmentTransaction ft2 = fm.beginTransaction();
        ft2.replace(R.id.frame,obj2);
        ft2.commit();
    }
